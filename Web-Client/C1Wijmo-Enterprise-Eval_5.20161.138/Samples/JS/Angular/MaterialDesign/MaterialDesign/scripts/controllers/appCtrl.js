...
app.controller('appCtrl', function ($scope) {
    ...
    // CSS url templates
    var CSS_WIJMO = 'http://cdn.wijmo.com/{version}/styles/themes/material/wijmo.theme.material.{colors}.min.css';
    ...
    $scope.themeChanged = function (s, e) {
        if (s.primary && s.accent) {
            ...
            $scope.wijmoUrl = CSS_WIJMO.replace('{colors}', colors).replace('{version}', wijmo.getVersion());
